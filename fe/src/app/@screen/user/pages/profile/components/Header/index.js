...
// Images
import avatar from "../../../../../../../assets/leader-logo.png";
          ...
          <Grid item>
            <MDBox height="100%" mt={0.5} lineHeight={1}>
              <MDTypography variant="h5" fontWeight="medium">
                {user.full_name} (Account ID: {user.id} - CRM PLATFORM Account ID: {user.crm_platform_account_id})
              </MDTypography>
              <MDTypography variant="button" color="text" fontWeight="regular">
                {user.role === ROLE.USER ? "Reseller" : "Admin"}
              </MDTypography>
            </MDBox>
          </Grid>
